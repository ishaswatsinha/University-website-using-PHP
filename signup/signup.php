  ...
  if(isset($_POST['submit2'])){
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `users` (`name`, `useremail`, `password`, `dt`) VALUES ('$name','$useremail', '$hash', current_timestamp())";
        ...
        <div class="column" id="main">
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="useremail" name="useremail" aria-describedby="emailHelp" placeholder="E-mail">
            </div>
            <div class="form-group">
...
<!--Forget  Modal -->
<div class="modal fade" id="forgatemodal" tabindex="-1" role="dialog" aria-labelledby="forgatemodalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <div class="column" id="main">
