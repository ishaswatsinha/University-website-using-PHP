...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  if(isset($_POST['submit2'])){
    ...
    $existSql = "SELECT * FROM `faculty` WHERE useremail = '$useremail'";
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `faculty` (`name`, `useremail`, `password`, `dt`) VALUES ('$name','$useremail', '$password', current_timestamp())";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  if(isset($_POST['submit1'])){
    ...
    $sql = "Select * from faculty where useremail='$username' ";
    $result = mysqli_query($conn, $sql);
    ...
    // ------------------------------------------------------
    $sql2 = "Select * from faculty where useremail='$username' "; 
