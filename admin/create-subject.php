...
$sql="INSERT INTO  tblsubjects(id,SubjectName,SubjectCode) VALUES(:subjectid,:subjectname,:subjectcode)";
...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `subject` (`id`, `name`) VALUES ('$subjectid', '$subjectname');";
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" name="subjectid" class="form-control"
                                                        id="default" placeholder="Subject Id" required="required">
                                                </div>
                                            </div>
