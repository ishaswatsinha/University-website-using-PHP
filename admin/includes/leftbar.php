<div class="left-sidebar bg-black-300 box-shadow ">
    <div class="sidebar-content">
        <div class="user-info closed">
            <img src="http://placehold.it/90/c2c2c2?text=User" alt="RKU" class="img-circle profile-img">
        ...
        <div class="sidebar-nav">
            ...
            <li class="has-children">
                <a href="#"><i class="fa fa-users"></i> <span>Accedmics</span> <i
                        class="fa fa-angle-right arrow"></i></a>
                <ul class="child-nav">
                    <li><a href="add-faculty.php"><i class="fa fa fa-server"></i> <span> Add Faculty</span></a>
                    </li>
                    ...
                    <li><a href="add-stdsub.php"><i class="fa fa fa-server"></i> <span> Student subjects</span></a>
                    </li>
                    <li><a href="add-facultysubject.php"><i class="fa fa fa-server"></i> <span> Faculty subjects</span></a>
                    </li>
            ...
            <!-- <li><a href="/project/faculty/dashboard/index.php"><i class="fa fa fa-server"></i> <span> Back to main
                        page</span></a>
            </li> -->
