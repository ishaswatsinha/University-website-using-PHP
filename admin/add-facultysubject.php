...
// INSERT INTO `user_subject` (`uid`, `id`) VALUES ('1', '2');
$sql="INSERT INTO  user_subject(uid,id) VALUES(:class,:subject)";
...
{   ?>
                                                        <option value="<?php echo htmlentities($result->uid); ?>">
                                                            <?php echo htmlentities($result->uname); ?>&nbsp;
                                                            user id-<?php echo htmlentities($result->uid); ?>
                                                        </option>
                                                        <?php }} ?>
                                                    </select>
                                                </div>
