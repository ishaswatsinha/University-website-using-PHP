...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,phone,RollId,StudentEmail,address,Gender,ClassId,DOB,Status) VALUES(:studentname,$phone1,:roolid,:studentemail,:address,:gender,:classid,:dob,:status)";
...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `student` ( `name`, `rollno`, `classid`) VALUES ( '$studentname', '$roolid', '$classid');";
                            ...
                            <div class="col-md-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <?php } ?>
                                        <form class="form-horizontal" action="add-students.php" method="post">
